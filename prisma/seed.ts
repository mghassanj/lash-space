...
async function main() {
  ...
  // Seed Lash Space services — Complete catalog from owner (Feb 2026)
  const services = [
    // Monthly Sessions (الجلسات الشهرية)
    {
      name: "Classic Monthly Lash Extensions",
      nameAr: "تركيب رموش كلاسيك شهرية",
      slug: "classic",
      description: "A natural, soft look for everyday wear. Applied lash-by-lash for a neat, elegant appearance that looks just like your natural lashes — only longer and slightly fuller. Perfect for clients with healthy lashes who love simplicity and softness.",
      descriptionAr: "إطلالة طبيعية وناعمة تناسب كل يوم، تقنية تركيبها شعرة على شعرة لتعطي شكل مرتب وأنيق وكأنها رموشك الطبيعية لكن أطول وأكثف قليلاً، مثالية للعميلة اللي رموشها صحية وتحب البساطة والنعومة",
      duration: 180,
      price: 300,
      category: "monthly",
      sortOrder: 1,
    ...
    {
      name: "Classic Hybrid Monthly Lash Extensions",
      nameAr: "تركيب رموش كلاسيك هايبرد شهرية",
      slug: "classic-hybrid",
      description: "A smart blend of Classic softness at the inner corner and Hybrid density at the outer edge, creating a naturally graduated look — soft on the inside, striking on the outside. Perfect for clients who love fine details and balanced elegance.",
      descriptionAr: "إطلالة ذكية تجمع بين نعومة الكلاسيك من الأمام وكثافة الهايبرد عند الطرف، تعطيك لوك طبيعي يتدرّج بشكل جذاب — ناعم من الداخل ومُلفت من الخارج، مثالية للعميلة اللي تحب التفاصيل الدقيقة والأناقة المتوازنة",
      duration: 180,
      price: 400,
      category: "monthly",
      sortOrder: 2,
    ...
    {
      name: "Hybrid Monthly Lash Extensions",
      nameAr: "تركيب رموش هايبرد شهرية",
      slug: "hybrid",
      description: "A perfect balance between density and softness, combining Classic and Volume techniques for a practical daytime look and an attractive evening look. Ideal for clients who prefer medium, eye-catching density.",
      descriptionAr: "توازن مثالي بين الكثافة والنعومة يجمع بين تقنية الكلاسيك والفوليوم لإطلالة عملية في النهار وجذابة بالليل، مثالية للعمية التي تفضل الكثافه متوسطة وجذابة",
      duration: 180,
      price: 450,
      category: "monthly",
      sortOrder: 3,
    ...
    {
      name: "Hybrid Volume Monthly Lash Extensions",
      nameAr: "تركيب رموش هايبرد فوليوم شهرية",
      slug: "hybrid-volume",
      description: "A graduated look starting with Hybrid at the inner corner and finishing with dense Volume at the outer edge, creating an elegant dramatic effect that highlights your eyes beautifully. Perfect for clients who want more density in a natural, graduated way.",
      descriptionAr: "لوك متدرّج يبدأ بهايبرد من الأمام وينتهي بفوليوم كثيف عند الطرف، يعطيك إطلالة درامية أنيقة تبرز عيونك بشكل مميز — مثالية للعميلة اللي تبي كثافة أعلى بس بطريقة متدرّجة وطبيعية",
      duration: 180,
      price: 500,
      category: "monthly",
      sortOrder: 4,
    ...
    {
      name: "Volume Monthly Lash Extensions",
      nameAr: "تركيب رموش فوليوم شهرية",
      slug: "volume",
      description: "A luxurious, dense look with a dramatic and attractive appearance. Multiple lash strands are applied to each natural lash, giving you perfect fullness and a sense of elegance and confidence.",
      descriptionAr: "لوّك فخم وكثيف يعطي مظهر درامي وجذاب، تُستخدم شعرات متعددة الرموش لكل رمش طبيعي لتمنحك امتلاء مثالي وإحساس بالرقي والثقة",
      duration: 180,
      price: 550,
      category: "monthly",
      sortOrder: 5,
    ...
    {
      name: "Wet Set Monthly Lash Extensions",
      nameAr: "تركيب رموش ويت سيت شهرية",
      slug: "wet-set",
      description: "A soft look that resembles freshly mascaraed lashes, applied using precise spikes for a look that's both natural and luxurious at the same time.",
      descriptionAr: "إطلالة ناعمة تشبه مظهر الرموش بعد الماسكارا تُركّب باستخدام سبايكس دقيقة مثالية للوك طبيعي وفخم في نفس الوقت",
      duration: 180,
      price: 450,
      category: "monthly",
      sortOrder: 6,
    ...
    // Add-on (إضافة)
    {
      name: "Wispy / Spikes Add-on",
      nameAr: "اضافة سبايكس (ويسبي)",
      slug: "wispy-addon",
      description: "Wispy isn't a separate lash type — it's a design style that can be applied to any lash type: Classic, Hybrid, Volume, or Wet Set. It uses graduated lengths with prominent spikes for a soft yet striking look. Perfect for clients who love a natural look with an elegant dramatic touch.",
      descriptionAr: "الويسبي مو نوع تركيب منفصل، هو أسلوب تصميم ممكن يُطبّق على أي نوع من الرموش – كلاسيك، هايبرد، فوليوم أو ويت سيت. يعتمد على توزيع أطوال متدرّجة مع سبايكس بارزة تعطي مظهر ناعم وملفت، مثالي للعميلة اللي تحب لوك طبيعي لكن فيه لمسة درامية أنيقة",
      duration: 0,
      price: 50,
      category: "addon",
      isAddOn: true,
    ...
    // Half Sets (طرف)
    {
      ...
      description: "Application on the outer corner only using Classic technique, giving a simple, natural touch that highlights the eye shape without a drastic change. Perfect for those who want a light, quick look.",
      descriptionAr: "تركيب على الطرف الخارجي فقط بتقنية الكلاسيك، يعطيك لمسة بسيطة وطبيعية تبرز شكل العين بدون تغيير كبير — مثالي للي تبي إطلالة خفيفة وسريعة",
      duration: 120,
      price: 150,
      category: "half_set",
      sortOrder: 8,
    },
    {
      ...
      description: "Application on the outer corner using Hybrid technique, giving noticeable density at the outer angle and an attractive, elongated eye shape. Perfect for those who love an elegant Cat Eye look.",
      descriptionAr: "تركيب على الطرف الخارجي بتقنية الهايبرد، يعطيك كثافة ملحوظة عند الزاوية الخارجية وشكل عين مسحوب وجذاب — مثالي للي تحب لوك Cat Eye أنيق",
      duration: 120,
      price: 200,
      category: "half_set",
      sortOrder: 9,
    },
    {
      ...
      description: "Dense application on the outer corner using Volume technique, creating a dramatic, eye-catching edge with visible fullness. Perfect for occasions or those who love a bold, distinctive look.",
      descriptionAr: "تركيب كثيف على الطرف الخارجي بتقنية الفوليوم، يعطيك طرف درامي وملفت مع حجم واضح — مثالي للمناسبات أو للي تحب إطلالة قوية ومميزة",
      duration: 120,
      price: 275,
      category: "half_set",
      sortOrder: 10,
    ...
    {
      name: "Weekly Lash Extensions",
      nameAr: "تركيب رموش اسبوعية",
      slug: "weekly-lashes",
      description: "An ideal option for quick occasions or a first-time experience. Lashes in various densities and lengths to suit every client's taste, applied with a quick technique lasting 7-10 days for a beautiful, natural look.",
      descriptionAr: "خيار مثالي للمناسبات السريعة أو للتجربة الأولى، رموش بكثافات واطوال مختلفة لتلتقي بذوق كل عميلة، تُركّب بتقنية سريعة وتستمر من 7 إلى 10 أيام، تعطيك إطلالة جميلة وطبيعية",
      duration: 45,
      price: 150,
      category: "other",
      sortOrder: 11,
    },
    {
      ...
      nameAr: "ازالة رموش",
      slug: "lash-removal",
      description: "A dedicated session to safely remove old lashes without affecting your natural ones. Using a gentle remover that softly dissolves the adhesive, leaving your lashes comfortable and ready for a new session.",
      descriptionAr: "جلسة مخصصة لإزالة الرموش القديمة بأمان دون التأثير على رموشك الطبيعية. تتم باستخدام مزيل لطيف يذيب اللاصق برفق، ليبقى شعرك مرتاح وجاهز لجلسة جديدة",
      duration: 45,
      price: 100,
      category: "other",
      sortOrder: 12,
    ...
    // Retouch (روتوش)
    {
      ...
      nameAr: "روتوش",
      slug: "retouch",
      description: "A maintenance session to fill gaps and maintain your lash look between monthly sessions. New lashes are applied where others have fallen to restore your look as good as new.",
      descriptionAr: "جلسة صيانة لتعبئة الفراغات والحفاظ على شكل الرموش بين الجلسات الشهرية، تُركّب رموش جديدة مكان اللي سقطت عشان ترجع الإطلالة كأنها جديدة",
      duration: 120,
      price: 0,
      category: "retouch",
      isRetouch: true,
