...
export const SERVICE_CATEGORIES = [
  {
    ...
    name: "Classic",
    nameAr: "كلاسيك",
    description: "Natural, elegant enhancement — one extension per lash",
    descriptionAr: "تعزيز طبيعي وأنيق — رمش واحد على كل رمش",
  },
  {
    slug: "hybrid",
    name: "Hybrid",
    nameAr: "هايبرد",
    description: "Best of both worlds — classic meets volume",
    descriptionAr: "الأفضل من كلا العالمين — كلاسيك يلتقي فوليوم",
  },
  {
    slug: "volume",
    name: "Volume",
    nameAr: "فوليوم",
    description: "Full, fluffy, dramatic — maximum impact",
    descriptionAr: "كثيفة وناعمة ودراماتيكية — أقصى تأثير",
  },
  {
    slug: "wet-set",
    name: "Wet Set",
    nameAr: "ويت سيت",
    description: "Sleek, defined, glossy — editorial look",
    descriptionAr: "أنيقة ومحددة ولامعة — إطلالة المجلات",
  },
  {
    slug: "weekly",
    name: "Weekly Lashes",
    nameAr: "رموش أسبوعية",
    description: "Quick, temporary glam — 30-45 minutes",
    descriptionAr: "إطلالة سريعة ومؤقتة — ٣٠-٤٥ دقيقة",
  },
  {
    slug: "other",
    name: "Other Services",
